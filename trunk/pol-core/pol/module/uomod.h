...
public:
	...
	BObjectImp* mf_ListMobilesInBox(/* x1, y1, z1, x2, y2, z2, realm */);
	...
	BObjectImp* mf_GetMidpointCircleCoords();
	BObjectImp* mf_GetSubTileCoord();
	...
	//BObjectImp* mf_CacheObject(/*key, BObjectImp */);
	//BObjectImp* mf_GetCachedObject(/*key, BObjectRef */);
	...
	//typedef std::hash_map<std::string, std::string> ImpCache;
	//static ImpCache super_cache; 
...
protected:
	...
	void internal_InBoxAreaChecks(unsigned short &x1, unsigned short &y1, long &z1, unsigned short &x2, unsigned short &y2, long &z2, Realm* realm);
