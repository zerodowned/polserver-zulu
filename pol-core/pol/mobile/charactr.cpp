...
2009/07/25 MuadDib:   equippable() now checks if a twohanded is intrinsic or not alsfo. Intrinsic gets ignored
...
{
	if(combat_config.core_attack_effects == false) {
		return;
	}
...
{
	if ( combat_config.core_attack_effects )
	{
...
void Character::tellmove()
{
	...
	ForEachMobileInRange( x, y, realm, 33, NpcPropagateMove, this );
